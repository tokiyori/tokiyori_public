...
class NewEntryImageWidget extends WP_Widget {
    ...
    function widget($args, $instance) {
        extract( $args );
        $title_new = ( ! empty( $instance['title_new'] ) ) ? $instance['title_new'] : __( 'Recent Posts' );
        $entry_count = ( ! empty( $instance['entry_count'] ) ) ? absint( $instance['entry_count'] ) : 5;
    ...
    public function form($instance) {
        $title_new = isset( $instance['title_new'] ) ? esc_attr( $instance['title_new'] ) : '';
        $entry_count = isset( $instance['entry_count'] ) ? absint( $instance['entry_count'] ) : 5;
        ?>
        <p>
