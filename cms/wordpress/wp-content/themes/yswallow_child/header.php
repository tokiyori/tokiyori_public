...
<body id="customize-wrapper" <?php body_class(); ?>>
<div id="container" class="<?php echo esc_html(get_option('post_options_ttl'));?> <?php echo esc_html(get_option('post_options_date','date_on'));?> <?php echo esc_html(get_option('post_options_postdesign','pd_normal'));?> <?php echo esc_html(get_option('post_options_label', 'catlabeloff'));?>">
    ...
    <header id="header" class="header animated fadeIn">
        <div id="inner-header" class="wrap cf">
            ...
            <?php if (is_active_sidebar('sidebar-sp')):?>
                <a href="#spnavi" data-remodal-target="spnavi" class="nav_btn sp_sav"><span class="text">MENU</span></a>
            ...
            <?php if(get_option('side_options_header_search','search_off') == 'search_on'):?>
                <div class="searchbox">
                    <form role="search" method="get" id="searchform" class="searchform cf" action="<?php echo home_url( '/' ) ?>" >
